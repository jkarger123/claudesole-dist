...
This node has Figma installed.

## What you can do
Read Figma files/components/frames for design-to-code via the Figma MCP.
- Pull frames, components, styles, and structure to implement designs accurately.
- Read-only; this does not edit Figma.
