...
This node has Sentry installed.

## What you can do
Production errors + issues via the Sentry MCP.
- Read issues/events/stack traces; summarize + triage the error posture.
- Read-first; resolving/ignoring issues only on request.
