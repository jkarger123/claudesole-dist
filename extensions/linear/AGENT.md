...
This node has Linear installed.

## What you can do
Read/manage Linear issues, projects, cycles via the Linear MCP.
- Search/read issues, projects, cycles; summarize status.
- Create/update issues only on request -- draft + confirm before writing.
