...
- `edge-mcp/` -- >> Resume here: read _handoffs/20260720-0309__edge-mcp.md first -- it is the latest handoff.
- `google-workspace/` -- >> Resume here: read _handoffs/20260719-2212__google-workspace.md first -- it is the latest handoff.
...
- `mediastudio/` -- >> Resume here: read _handoffs/20260725-0541__mediastudio.md first -- it is the latest handoff.
