# Atlassian (Jira + Confluence) -- agent guide

This node has Atlassian (Jira + Confluence) installed.

## What you can do
Read + manage Jira issues and Confluence pages via the Atlassian MCP.
- Search/read issues, comments, sprints; read Confluence pages/spaces.
- Create/update issues + pages ONLY on explicit request -- draft the change, confirm, then apply.
