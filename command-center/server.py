...
@font-face{font-family:'Cinzel Decorative';src:url('/static/brand/CinzelDecorative-Bold.ttf') format('truetype');font-weight:700;font-style:normal;font-display:swap}
